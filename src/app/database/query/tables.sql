...
CREATE TABLE scientific_communications (
    ...
    presentation_year INTEGER NOT NULL ,
...
CREATE TABLE patents (
    ...
    authors VARCHAR(128) NOT NULL ,
    year_of_obtaining_patent INTEGER NOT NULL ,
...
CREATE TABLE research_contracts (
    ...
    start_project_period DATE NOT NULL ,
    end_project_period DATE NOT NULL ,
...
CREATE TABLE editorial_member (
    ...
    year_of_committee_attendance INTEGER NOT NULL ,
...
CREATE TABLE didactic_activity (
    ...
    year_of_attending_activity INTEGER NOT NULL ,
    owner INTEGER NOT NULL ,
    updated TIMESTAMP NOT NULL ,
