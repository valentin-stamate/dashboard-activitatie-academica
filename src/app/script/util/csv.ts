...
/* Taken From https://c2fo.github.io/fast-csv/docs/formatting/examples/#appending-to-a-csv */
...
export class CsvFile {
    ...
    constructor(opts: CsvFileOpts) {
        ...
        this.path = opts.path;
        this.writeOpts = { headers: this.headers, delimiter: ';', includeEndRowDelimiter: true };
    }
